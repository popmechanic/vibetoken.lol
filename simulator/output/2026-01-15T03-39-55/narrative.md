...
**ROI Rankings (Mean):**
- Conservative Holder: 12.36x ██████████
- Founder's Friend: 4.20x ████
- Early Adopter: 3.08x ███

**Behavior Analysis:**

**Rational actors** achieved 6.55x average ROI. Their conservative approach may have triggered premature exits in some successful scenarios.
...
2. **Conservative Holder** achieved highest returns (12.36x), while **Early Adopter** achieved lowest (3.08x).

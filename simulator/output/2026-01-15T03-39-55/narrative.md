...
- Early Adopter: 3.09x ███
- Conservative Holder: 2.03x ██

**Behavior Analysis:**

**Rational actors** achieved 3.11x average ROI. Their conservative approach may have triggered premature exits in some successful scenarios.
...
2. **Founder's Friend** achieved highest returns (4.20x), while **Conservative Holder** achieved lowest (2.03x).

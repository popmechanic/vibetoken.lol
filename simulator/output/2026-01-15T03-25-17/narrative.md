...
**ROI Rankings (Mean):**
- Conservative Holder: 13.46x ██████████
- Founder's Friend: 4.19x ████
- Early Adopter: 3.07x ███

**Behavior Analysis:**

**Rational actors** achieved 6.91x average ROI. Their conservative approach may have triggered premature exits in some successful scenarios.
...
2. **Conservative Holder** achieved highest returns (13.46x), while **Early Adopter** achieved lowest (3.07x).
